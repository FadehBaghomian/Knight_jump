...
BG = pygame.transform.scale(pygame.image.load(os.path.join("Assets/bg.jpg")), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
def draw_bg(bg_scroll):
    ...
    screen.blit(BG, (0, -900 + scroll))


# player class
class Player():
    def __init__(self, x, y):
        self.image = pygame.transform.scale(Knight, (45, 45))
        self.width = 25
        self.height = 40
...
class Platform(pygame.sprite.Sprite):
    ...
    def update(self, scroll):
        ...
        # Change direction if it goes off-screen
...
while run:
    ...
    if game_over == False:
        ...
        pygame.draw.line(screen, WHITE, (0, score - high_score + SCROLL_THRSH),
                         (SCREEN_WIDTH, score - high_score + SCROLL_THRSH), 3)
        draw_text('HIGH SCORE', font_small, WHITE, SCREEN_WIDTH - 130, score - high_score + SCROLL_THRSH)
        ...
        if fade_counter < SCREEN_WIDTH:
            ...
            draw_text('The knight has perished!', font_big, WHITE, 172, 200)
            draw_text('SCORE: ' + str(score), font_big, WHITE, 250, 250)
            draw_text('PRESS SPACE TO PLAY AGAIN', font_big, WHITE, 140, 300)
            # update high score
            if score > high_score:
                high_score = score
